    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="mis-solicitudes.html">
                        <i class="fas fa-fw fa-folder"></i>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form action="administrador.jsp" method="post" >
                            ...
                            <input type="text" size="8" maxlength="10" value="10000001" name="codigo">
                            <br>
                            <label>FECHA: </label><br>
                            <input type="text" size="10" maxlength="10" placeholder="dd/mm/aaaa" name="fecha">
                            <br>
                            <label>ASUNTO: </label><br>
                            <input type="text" size="30" maxlength="60" value="" name="asunto">
                            <br>
                            <label>MENSAJE: </label><br>
                            <textarea name="texto" rows="4" cols="40" placeholder="Escriba su mensaje aquí"></textarea>
                            <br>
                           <input type="submit" name="btnEnviar"  value="Enviar">  
                            <input type="reset" name="btnBorar" value="Borrar">
                        </form>
                    </div>
                    <!-- /.container-fluid -->
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Juan Celis 2021</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
